export const pitcherTrendsObj = {
  ...
  image: require("../../images/portfolio/pitchertrends.png").default,
  thumbnail: require("../../images/thumbnails/pitchertrends-thumb.png").default,
  desc: "A simple Ruby on Rails data visualization application that displays baseball pitcher trends over the course of a season. It can help highlight potential performance irregularities or health risks. Built using Ruby on Rails, Postgresql, and JavaScript library ChartJS.",
...
export const amazonObj = {
  ...
  desc: "This is a basic functionality ecommerce website built using React for the frontend, Firebase for the backend database, and stripe for payment processing. I built it primarily to learn and practice basic frontend development and styling with React",
...
export const tedSurfObj = {
  ...
  desc: "It's firing! This simple desktop and mobile friendly Vue.js application gives you the surf forecast for three of my favorite surfing destinations. It retrieves data from a mainstream surf forecast provider's API that doesn't seem to be very secure.",
...
export const monthlyVueObj = {
  ...
  image: require("../../images/portfolio/monthlyvue.png").default,
  thumbnail: require("../../images/thumbnails/monthlyvue-thumb.png").default,
  desc: "What's the action? Check your schedge with this calendar app built with Vue.js. It makes use of Vuetify for frontend styling and Google Firebase for it's backend database.",
...
export const depthChartObj = {
  ...
  image: require("../../images/portfolio/depthchart.png").default,
  thumbnail: require("../../images/thumbnails/depthchart-thumb.png").default,
  desc: "Drag and drop players and rearrange them however you want to build your team! Depth charts are updated and saved to the backend via an AJAX request that is triggered when the chart gets updated.",
...
export const tedTypeObj = {
  ...
  image: require("../../images/portfolio/tedtype.png").default,
...
export const teddygramsObj = {
  ...
  image: require("../../images/portfolio/teddygrams.png").default,
...
export const tedTalksObj = {
  ...
  image: require("../../images/portfolio/tedtalks.png").default,
  thumbnail: require("../../images/thumbnails/tedtalks-thumb.png").default,
  desc: "This was the first portfolio website I made. I spent a lot of time building a website with a simple, clean, and streamlined look.",
  tech: ["Ruby on Rails"],
...
export const beatsByTedObj = {
  ...
  image: require("../../images/portfolio/tedbeats.png").default,
  thumbnail: require("../../images/thumbnails/tedbeats-thumb.png").default,
...
export const tedWeathermanObj = {
  ...
  image: require("../../images/portfolio/tedweatherman.png").default,
  thumbnail: require("../../images/thumbnails/tedweatherman-thumb.png").default,
  desc: "Forget the umbrella! This React application tells you the weather for whatever location you enter by fetching data from the OpenWeatherMap API.",
...
export const tedspaceObj = {
  ...
  image: require("../../images/portfolio/tedspace.png").default,
  thumbnail: require("../../images/thumbnails/tedspace-thumb.png").default,
  desc: "tedspace is my second portfolio website built using Ruby on Rails and Postgresql. Photos and videos are hosted on AWS, blog posts were rarely updated, and there's an entire page dedicated to the worst of twitter.",
...
export const tedspaceReactObj = {
  ...
  image: require("../../images/portfolio/tedspace-react.png").default,
  thumbnail: require("../../images/thumbnails/tedspace-react-thumb.png")
    .default,
  desc: "I rebuilt my last portfolio website into a concise, mobile-friendly and responsive website using React. I made use of the popular 'styled-components' React module to style the entire project.",
...
export const covidTrackerObj = {
  ...
  desc: "This desktop and mobile friendly data visualization app uses ChartJS and Leaflet to display worldwide COVID-19 data provided by the disease.sh API. I don't know what to believe anymore!",
...
export const scouted = {
  id: 19,
  name: "scouted",
  title: "scouted",
  subtitle: "Not another baseball project!",
  image: require("../../images/portfolio/scouted.png").default,
  thumbnail: require("../../images/thumbnails/scouted-thumb.png").default,
  desc: "scouted is an ongoing baseball project that was originally built with Ruby on Rails. I've recently been transitioning towards Elixir and it's related framework Phoenix and have used this project as my main method of learning both. Learning new languages, technologies, and paradigms like functional programming, Ecto, and LiveView has been both, challenging and really fun. I think Elixir and Phoenix can make a huge impact on website development, and I'm excited to work more with both. JavaScript frameworks suck, so let's hope Elixir, Phoenix, and LiveView take off. Take a look inside with the login 'guest@scouted.com', and password: 'password'.",
